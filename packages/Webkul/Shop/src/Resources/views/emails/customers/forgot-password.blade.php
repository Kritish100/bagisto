@component('shop::emails.layout')
    ...
    <div style="display: flex;margin-bottom: 95px">
        <a
            ...
            style="padding: 16px 45px;justify-content: center;align-items: center;gap: 10px;border-radius: 2px;background: #BF472C;color: #FFFFFF;text-decoration: none;text-transform: uppercase;font-weight: 700;"
        >
