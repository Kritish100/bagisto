    ...
    >
        ...
        >
            <div class="relative">
                ...
                <span
                    class="icon-arrow-left-stylish absolute -left-10 top-9 flex h-[50px] w-[50px] cursor-pointer items-center justify-center rounded-full border border-white bg-white text-2xl text-navyBlue transition hover:bg-black hover:text-white max-lg:-left-7 max-md:hidden"
                    role="button"
                ...
                <span
                    class="icon-arrow-right-stylish absolute -right-6 top-9 flex h-[50px] w-[50px] cursor-pointer items-center justify-center rounded-full border border-white bg-white text-2xl text-navyBlue transition hover:bg-black hover:text-white max-lg:-right-7 max-md:hidden"
                    role="button"
